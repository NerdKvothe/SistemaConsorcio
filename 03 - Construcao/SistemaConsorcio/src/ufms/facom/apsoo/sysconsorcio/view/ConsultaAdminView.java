...
import ufms.facom.apsoo.sysconsorcio.controller.AdministradoraJpaController;
 ...
 * @author joshua
 */
public class ConsultaAdminView extends javax.swing.JDialog {

    private int selected;

    private EntityManagerFactory emf;
    private AdministradoraJpaController administradoraController;
    private Administradora administradora;
    
    /**
     * Creates new form ConsultaVendaView
     */
    public ConsultaAdminView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        administradoraController = new AdministradoraJpaController(emf);
        List<Administradora> administradoras = administradoraController.findAdministradoraEntities();

        DefaultTableModel tableModel = (DefaultTableModel)jTableResult.getModel();
        tableModel.setNumRows(administradoras.size());
        
        int row = 0;
        for(Administradora a : administradoras) {
            tableModel.setValueAt(a.getCodigoAdm(), row, 0);
            tableModel.setValueAt(a.getNome(), row, 1);
    ...
    private void jButtonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOkActionPerformed
        ...
        if (selected != -1) {
            administradora = administradoraController.findAdministradora((int) jTableResult.getValueAt(selected, 0));
        }
        else {
            administradora = null;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaAdminView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultaAdminView dialog = new ConsultaAdminView(new javax.swing.JFrame(), true);
