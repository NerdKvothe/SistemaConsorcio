...
import ufms.facom.apsoo.sysconsorcio.controller.ClienteJpaController;
 ...
 * @author joshua
 */
public class ConsultaClienteView extends javax.swing.JDialog {
     ...
     */
    public ConsultaClienteView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tableModel.setNumRows(clientes.size());
        
        int row = 0;
        for(Cliente c : clientes) {
            tableModel.setValueAt(c.getCodigoCliente(), row, 0);
            tableModel.setValueAt(c.getCpf(), row, 1);
            tableModel.setValueAt(c.getNome(), row, 2);
    ...
    private void jButtonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOkActionPerformed
        ...
        if (selected != -1) {
            cliente = clienteController.findCliente((int) jTableResult.getValueAt(selected, 0));
        }
        else {
            cliente = null;
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultaClienteView dialog = new ConsultaClienteView(new javax.swing.JFrame(), true);
